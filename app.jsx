...
const TRANSPORT={
1:{from:"Narita",to:"Asakusa",mode:"train",min:90,yen:1340,note:"Keisei Skyliner + Metro"},
2:{from:"Tokyo",to:"Tokyo",mode:"local",min:0,yen:0,note:"Interno città"},
3:{from:"Asakusa",to:"Nikkō",mode:"train",min:120,yen:2800,note:"Tobu Limited Express"},
4:{from:"Nikkō",to:"Aizu-Wakamatsu",mode:"train",min:180,yen:3500,note:"JR Nikkō → Utsunomiya → Kōriyama"},
5:{from:"Aizu",to:"Sendai",mode:"train",min:150,yen:2800,note:"JR Ban-etsu West → Kōriyama → Sendai"},
6:{from:"Sendai",to:"Matsushima+Yamadera",mode:"train",min:180,yen:2500,note:"JR Senseki + Senzan Line"},
7:{from:"Sendai",to:"Matsushima",mode:"train",min:40,yen:420,note:"JR Senseki Line"},
8:{from:"Sendai",to:"Morioka",mode:"shin",min:50,yen:6500,note:"Shinkansen Hayabusa"},
9:{from:"Morioka",to:"Tazawako",mode:"shin",min:45,yen:3200,note:"Komachi"},
10:{from:"Tazawa",to:"Nagano",mode:"shin",min:180,yen:12500,note:"Komachi → Tokyo → Kagayaki"},
11:{from:"Nagano",to:"Jigokudani",mode:"bus",min:90,yen:1400,note:"Bus locale + walk"},
12:{from:"Nagano",to:"Suwa",mode:"train",min:60,yen:1340,note:"JR Chūō Line"},
13:{from:"Suwa",to:"Shirakawa-gō",mode:"bus",min:240,yen:5500,note:"Highway bus via Takayama"},
14:{from:"Shirakawa-gō",to:"Kanazawa",mode:"bus",min:90,yen:2000,note:"Nōhi Bus"},
15:{from:"Kanazawa",to:"Nagoya",mode:"shin",min:150,yen:7500,note:"Thunderbird → Shinkansen"},
16:{from:"Nagoya",to:"Kyoto",mode:"shin",min:35,yen:5500,note:"Nozomi"},
17:{from:"Kyoto",to:"Kyoto",mode:"local",min:0,yen:0,note:"Interno città"},
18:{from:"Kyoto",to:"Arashiyama",mode:"train",min:30,yen:240,note:"JR Sagano Line"},
19:{from:"Kyoto",to:"Osaka",mode:"train",min:30,yen:570,note:"JR Special Rapid"},
20:{from:"Osaka",to:"USJ",mode:"train",min:20,yen:180,note:"JR Yumesaki Line"},
21:{from:"Osaka",to:"Osaka",mode:"local",min:0,yen:0,note:"Interno città"},
22:{from:"Osaka",to:"Ine",mode:"van",min:180,yen:4500,note:"🚐 Van pickup + costa nord"},
23:{from:"Ine",to:"Tottori",mode:"van",min:180,yen:4500,note:"Van + Tottori Sand Dunes"},
24:{from:"Tottori",to:"Matsue",mode:"van",min:120,yen:3000,note:"Van lungo costa San'in"},
25:{from:"Matsue",to:"Hiroshima",mode:"van",min:180,yen:4500,note:"Van + Izumo Taisha"},
26:{from:"Hiroshima",to:"Miyajima",mode:"ferry",min:60,yen:380,note:"JR + ⛴️ Ferry"},
27:{from:"Hiroshima",to:"Yamaguchi",mode:"van",min:120,yen:3000,note:"Van verso costa nord"},
28:{from:"Yamaguchi",to:"Shimonoseki",mode:"van",min:240,yen:5500,note:"Van costa nord · Motonosumi + Tsunoshima"},
29:{from:"Shimonoseki",to:"Fukuoka",mode:"van",min:90,yen:2500,note:"Van + Kanmon Tunnel sottomarino"},
30:{from:"Fukuoka",to:"Yanagawa",mode:"van",min:60,yen:1500,note:"Van ~60km + Nanzo-in Buddha"},
31:{from:"Yanagawa",to:"Kagoshima",mode:"van",min:240,yen:6000,note:"Van ~250km verso sud estremo Kyushu"},
32:{from:"Kagoshima",to:"Miyazaki",mode:"van",min:180,yen:4500,note:"Van ~180km costa Pacifico"},
33:{from:"Miyazaki",to:"Takachiho",mode:"van",min:120,yen:3000,note:"Van ~120km montagna sacra"},
34:{from:"Takachiho",to:"Aso",mode:"van",min:90,yen:2500,note:"Van via Kurokawa Onsen"},
35:{from:"Aso",to:"Hita",mode:"van",min:120,yen:3000,note:"Van ~100km Attack on Titan town"},
36:{from:"Hita",to:"Beppu",mode:"van",min:90,yen:2000,note:"Van via Yufuin + Bungo-Mori"},
37:{from:"Beppu",to:"Matsuyama",mode:"ferry",min:180,yen:12800,note:"⛴️ Traghetto veicolare → Shikoku"},
38:{from:"Matsuyama",to:"Kochi",mode:"van",min:180,yen:4500,note:"Van ~180km via UFO Line"},
39:{from:"Kochi",to:"Iya Valley",mode:"van",min:180,yen:4500,note:"Van ~180km montagne Tokushima"},
40:{from:"Iya Valley",to:"Naruto",mode:"van",min:120,yen:3000,note:"Van discesa verso costa"},
41:{from:"Naruto",to:"Awaji",mode:"van",min:60,yen:2000,note:"Van Awaji + Tadao Ando"},
42:{from:"Awaji",to:"Osaka",mode:"van",min:90,yen:2500,note:"Van ~90km rientro Kansai"},
43:{from:"Osaka KIX",to:"Naha",mode:"plane",min:120,yen:15000,note:"✈️ Peach Aviation"},
44:{from:"Naha",to:"Kerama",mode:"ferry",min:60,yen:3200,note:"⛴️ Ferry alta velocità"},
45:{from:"Naha",to:"Kyoto",mode:"plane",min:120,yen:18000,note:"✈️ Rientro Honshu"},
46:{from:"Kyoto",to:"Kyoto",mode:"local",min:0,yen:0,note:"Interno città"},
47:{from:"Kyoto",to:"Kyoto",mode:"local",min:0,yen:0,note:"Interno città"},
48:{from:"Kyoto",to:"Tokyo",mode:"shin",min:135,yen:13500,note:"Nozomi"},
49:{from:"Tokyo",to:"Haneda",mode:"train",min:30,yen:500,note:"Monorail"}
};
...
const D0=[
{n:1,d:"28/05",dow:"Mar",c:"Narita → Asakusa",j:"L\'Arrivo a Tokyo",p:1,sl:"Tokyo",
...
{n:2,d:"29/05",dow:"Mer",c:"Tokyo",j:"Tokyo Ottimizzato",p:1,sl:"Tokyo",
 a:["Tsukiji Outer Market","Spostamento verso Shibuya","Shibuya Sky","Spostamento verso Nakano","Nakano Broadway"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:3,d:"30/05",dow:"Gio",c:"Tokyo → Nikkō",j:"L\'Incanto di Nikkō",p:1,sl:"Nikkō",
 a:["‍♂️ CORSA 2: Pista Oda Field","Tobu Limited Express Kegon","Arrivo a Nikkō & Logistica","Shinkyo Bridge","Tōshō-gū Shrine"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:4,d:"31/05",dow:"Ven",c:"Nikkō → Fukushima",j:"L\'Anima dei Samurai nel Tōhoku",p:1,sl:"Fukushima",
...
{n:5,d:"01/06",dow:"Sab",c:"Fukushima → Sendai",j:"Spiriti Kitsune e la Città degli Alberi",p:1,sl:"Sendai",
...
{n:6,d:"02/06",dow:"Dom",c:"Sendai → Matsushima+Yamadera",j:"L\'Ascesa a Yamadera e l\'Estetica di Sendai",p:1,sl:"Sendai",
...
{n:7,d:"03/06",dow:"Lun",c:"Sendai → Matsushima",j:"Le Isole di Pini e il Tramonto sul Fiume",p:1,sl:"Sendai",
...
{n:8,d:"04/06",dow:"Mar",c:"Morioka",j:"Tradizione, Granito e la Sfida della Soba",p:1,sl:"Morioka",
...
{n:9,d:"05/06",dow:"Mer",c:"Morioka → Tazawako",j:"Il Lago Indaco e l\'Acqua Lattiginosa",p:1,sl:"Tazawako",
 a:["🚄 Il Proiettile Rosso","Arrivo e Drop Bagagli","‍♂️ RUN 1: Giro del Lago Tazawa","📍 La Statua di Tatsuko","🏁 Fine Corsa e Ricarica Carboidrati"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:10,d:"06/06",dow:"Gio",c:"Tazawa → Nagano",j:"Il Grande Salto e la Chiave del Paradiso",p:1,sl:"Nagano",
...
{n:11,d:"07/06",dow:"Ven",c:"Nagano → Jigokudani",j:"I Macachi e il Ritiro di Hokusai",p:1,sl:"Nagano",
...
{n:12,d:"08/06",dow:"Sab",c:"Nagano → Suwa",j:"Le Alpi e il Cratere di Itomori",p:1,sl:"Suwa",
...
{n:13,d:"09/06",dow:"Dom",c:"Suwa → Shirakawa-gō",j:"Corsa sul Lago e Corsa contro il Tempo",p:1,sl:"Shirakawa-gō",
 a:["‍♂️ RUN 2: Il Giro del Lago Suwa","Recupero: Onsen Katakurakan","Treno verso il Mar del Giappone","Arrivo a Toyama & Sprint","🚨 ULTIMO BUS: Toyama → Shirakawa-gō"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:14,d:"10/06",dow:"Lun",c:"Shirakawa-gō → Kanazawa",j:"Dalla Nebbia all\'Oro di Kanazawa",p:1,sl:"Kanazawa",
...
{n:15,d:"11/06",dow:"Mar",c:"Kanazawa → Nagoya",j:"Acque di Cristallo e Castelli nella Valle",p:1,sl:"Nagoya",
...
{n:16,d:"12/06",dow:"Mer",c:"Nagoya → Kyoto",j:"L\'Underground di Nagoya e l\'Archivio di Kyoto",p:1,sl:"Kyoto",
 a:["Sfratto e Logistica","👾 Esplorazione Osu Shopping District","La Scorta Ghibli","🥩 Pranzo Ignorante: Misokatsu","🚄 Il Salto Temporale: Shinkansen per Kyoto"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:17,d:"13/06",dow:"Gio",c:"Kyoto",j:"L\'Alba Vermiglia e i Fuochi della Cucina",p:1,sl:"Kyoto",
 a:["⏰ La Sveglia Brutale","Fushimi Inari-taisha","Colazione/Recupero post-scalata","🏛️ Kiyomizu-dera & Le Strade Storiche","Pokemon Center Kyoto"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:18,d:"14/06",dow:"Ven",c:"Kyoto → Arashiyama",j:"Le 1200 Facce e l\'Oro Riflesso",p:1,sl:"Kyoto",
...
{n:19,d:"15/06",dow:"Sab",c:"Kyoto → Osaka",j:"L\'Impatto con il Caos del Kansai",p:1,sl:"Osaka",
 a:["Ultime compere a Kyoto","Lo Shinkaisoku","Check-in Guesthouse U-En Osaka","Shinsekai: Retro-Futurismo","🦞 Kuromon Ichiba Market"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:20,d:"16/06",dow:"Dom",c:"Osaka → USJ",j:"USJ e la Pura Adrenalina",p:1,sl:"Osaka",
...
{n:21,d:"17/06",dow:"Lun",c:"Osaka",j:"Otaku Culture, Capibara e Preparativi",p:1,sl:"Osaka",
...
{n:22,d:"18/06",dow:"Mar",c:"Osaka → Ine",j:"Le Case sull\'Acqua e la Prima Notte su Ruote",p:2,sl:"🚐 Van",
...
{n:23,d:"19/06",dow:"Mer",c:"Ine → Tottori",j:"Dalle Grotte Marine al \"Sahara Giapponese\"",p:2,sl:"🚐 Van",
...
{n:24,d:"20/06",dow:"Gio",c:"Tottori → Matsue",j:"Dai Manga al Legno Scuro dei Samurai",p:2,sl:"🚐 Van",
...
{n:25,d:"21/06",dow:"Ven",c:"Matsue → Hiroshima",j:"La Cordigliera e la Piastra di Hiroshima",p:2,sl:"🚐 Van",
...
{n:26,d:"22/06",dow:"Sab",c:"Hiroshima → Miyajima",j:"Il Torii Galleggiante e il Mare di Seto",p:2,sl:"🚐 Van",
...
{n:27,d:"23/06",dow:"Dom",c:"Hiroshima → Yamaguchi",j:"Vento Salmastro, Acque Cobalto e il Veleno nel Piatto",p:2,sl:"🚐 Van",
...
{n:28,d:"24/06",dow:"Lun",c:"Yamaguchi → Shimonoseki",j:"La Pietra Spaccata, Sartoria Urbana e i Bassifondi",p:2,sl:"🚐 Van",
 a:["Il Salto Sottomarino","Shohachiman Shrine","L\'Impatto con Fukuoka","‍♂️ CORSA 8: Ohori Park","Nakasu Yatai"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:29,d:"25/06",dow:"Mar",c:"Shimonoseki → Fukuoka",j:"Il Gigante di Bronzo e le Vere Origini del Sapore",p:2,sl:"🚐 Van",
...
{n:30,d:"26/06",dow:"Mer",c:"Fukuoka → Yanagawa",j:"Pali nell\'Acqua, Bronzo e Carne Cruda",p:2,sl:"🚐 Van",
...
{n:31,d:"27/06",dow:"Gio",c:"Yanagawa → Kagoshima",j:"Cenere, Maiali Neri e il Cratere Fumante (KAGOSHIMA)",p:2,sl:"🚐 Van",
...
{n:32,d:"28/06",dow:"Ven",c:"Kagoshima → Miyazaki",j:"Palme, Fiamme Nere e le Lanterne di Nishitachi",p:2,sl:"🚐 Van",
 a:["Taglio Verso la Costa del Pacifico","🌴 Aoshima e la Tavola del Lavandaio","🍗 Calorie e Aceto: Il Chicken Nanban","Udo Jingu","‍♂️ Corsa al Tramonto sulla Costa Nichinan"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:33,d:"29/06",dow:"Sab",c:"Miyazaki → Takachiho",j:"La Foresta degli Spiriti e la Gola di Smeraldo",p:2,sl:"🚐 Van",
...
{n:34,d:"30/06",dow:"Dom",c:"Takachiho → Aso",j:"Corsa sul Cratere e le Terme Nascoste",p:2,sl:"🚐 Van",
...
{n:35,d:"01/07",dow:"Lun",c:"Aso → Hita",j:"Il Giorno del Giudizio (HITA - ATTACK ON TITAN)",p:2,sl:"🚐 Van",
...
{n:36,d:"02/07",dow:"Mar",c:"Hita → Beppu",j:"Le Porte di Suzume, Crocchette e l\'Inferno di Vapore",p:2,sl:"🚐 Van",
...
{n:37,d:"03/07",dow:"Mer",c:"Beppu → Matsuyama",j:"Sangue, Pietra e l\'Imbarco per lo Shikoku",p:2,sl:"🚐 Van",
...
{n:38,d:"04/07",dow:"Gio",c:"Matsuyama → Kochi",j:"Il Taglio delle Montagne e il Mercato del Fuoco",p:2,sl:"🚐 Van",
 a:["🏰 L\'Addio a Matsuyama","Katsurahama Beach","Kochi Castle","‍♂️ CORSA 11: Pista Haruno Athletic Park","🔥 Hirome Ichiba"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:39,d:"05/07",dow:"Ven",c:"Kochi → Iya Valley",j:"L\'Extra Day: La Valle Nascosta dei Samurai (IYA VALLEY)",p:2,sl:"🚐 Van",
...
{n:40,d:"06/07",dow:"Sab",c:"Iya Valley → Naruto",j:"Vortici Mortali e l\'Isola di Awaji",p:2,sl:"🚐 Van",
...
{n:41,d:"07/07",dow:"Dom",c:"Naruto → Awaji",j:"Cemento Brutalista e il Rientro nel Kansai (NARA)",p:2,sl:"🚐 Van",
...
{n:42,d:"08/07",dow:"Lun",c:"Awaji → Osaka",j:"Scarico Aerobico, Rientro e l\'Ultima Notte a Osaka",p:2,sl:"Osaka",
 a:["‍♂️ Corsa all\'Alba a Nara Park","🧽 Check Logistico del Van","La Discesa nel Gorgo: Osaka","Shimokitazawa del Kansai: Nakazaki-cho o Amerikamura","🐙 Shinsekai o Dotonbori"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:43,d:"09/07",dow:"Mar",c:"Osaka KIX → Okinawa",j:"Il Passaggio di Consegne e il Volo a Sud",p:3,sl:"Okinawa",
...
{n:44,d:"10/07",dow:"Mer",c:"Naha → Kerama",j:"Il Salto nel \"Kerama Blue\"",p:3,sl:"Okinawa",
 a:["🚢 Il Porto di Tomari","Aharen Beach","‍♂️ Scarico Aerobico sul Lungomare","🥃 Il Rito dello Yuntaku in Terrazza"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:45,d:"11/07",dow:"Gio",c:"Okinawa → Kyoto",j:"Canne da Zucchero, Forni di Fango e Pollo all\'Aglio",p:3,sl:"Kyoto",
...
{n:46,d:"12/07",dow:"Ven",c:"Kyoto",j:"I Cervi Selvatici della Spiaggia Bianca",p:3,sl:"Kyoto",
...
{n:47,d:"13/07",dow:"Sab",c:"Kyoto",j:"L\'Ultimo Respiro di Oceano e il Ritorno a Kyoto",p:3,sl:"Kyoto",
 a:["‍♂️ L\'Ultima Sessione Tropicale","🧽 Svuotamento Capsula e Check-out","🛂 Aeroporto di Naha (OKA) & Check-in","🛫 Volo GK352 - Decollo","🛬 Atterraggio a KIX"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:48,d:"14/07",dow:"Dom",c:"Kyoto → Tokyo",j:"Il Gion Matsuri e lo Shinkansen della Morte",p:3,sl:"Tokyo",
 a:["🪵 L\'Immensità dei Carri","Il Delirio di Lanterne e Street Food","‍♂️ Lo Strappo e la Corsa alla Stazione","🚄 L\'Ultimo Treno per Tokyo","Arrivo a Tokyo & Logistica Notturna"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
{n:49,d:"15/07",dow:"Lun",c:"Tokyo → Haneda",j:"Il Gate e i Titoli di Coda",p:3,sl:"Tokyo",
 a:["‍♂️ CORSA 14: Palazzo Imperiale (Il Giro d\'Onore) - OPZIONALE","🛂 Controllo Bagagli e Faccia da Zombie","L\'Ultimo Tè Verde al Terminal 3","✈️ Imbarco Gate","🛫 Il Decollo Finale"],m:[],b:55,st:"ok",nt:"",
   schedule:[
...
function MapView(){
  ...
  useEffect(()=>{
    // Se l'iframe non segnala il caricamento entro 4s, mostriamo il fallback
    const t=setTimeout(()=>{ if(!loaded) setFailed(true); },4000);
    ...
    <div style={{maxWidth:860,margin:"0 auto",padding:"16px 12px"}}>
      <div style={{background:"white",borderRadius:8,padding:"20px",boxShadow:"0 2px 8px rgba(0,0,0,.08)"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:16,flexWrap:"wrap",gap:10}}>
          <h2 style={{margin:0,fontSize:22,fontWeight:900,color:"#1B4332"}}>
            {MAPPA_CONFIG.title}
          </h2>
          <a href={MAPPA_CONFIG.editUrl} target="_blank" rel="noopener noreferrer"
            style={{padding:"8px 16px",border:"none",borderRadius:6,background:"#2563eb",color:"white",fontWeight:700,fontSize:13,textDecoration:"none",whiteSpace:"nowrap"}}>
            🔗 Apri / Modifica online
          </a>
        </div>

        <div style={{position:"relative",width:"100%",height:0,paddingBottom:"75%",borderRadius:8,overflow:"hidden",border:"1px solid #e5e7eb",background:"#f1f5f9"}}>
          <iframe
            src={MAPPA_CONFIG.embedUrl}
            title="Mappa Itinerario Giappone"
          ...
          />
          {failed && !loaded && (
            <div style={{position:"absolute",top:0,left:0,width:"100%",height:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:14,padding:20,textAlign:"center",background:"#f8fafc"}}>
              <div style={{fontSize:40}}>🗾</div>
              <div style={{fontSize:14,fontWeight:700,color:"#475569",maxWidth:360}}>
                La mappa interattiva non si carica qui dentro (è una restrizione di Google). Aprila direttamente:
              </div>
              <a href={MAPPA_CONFIG.editUrl} target="_blank" rel="noopener noreferrer"
                style={{padding:"12px 22px",border:"none",borderRadius:8,background:"#1B4332",color:"white",fontWeight:800,fontSize:15,textDecoration:"none"}}>
                🗺️ Apri la mappa del viaggio
              </a>
            </div>
          )}
        </div>
        ...
        <p style={{margin:"12px 0 0",fontSize:12,color:"#888",textAlign:"center"}}>
          Se la mappa resta vuota, usa il tasto blu "Apri / Modifica online" qui sopra.
        </p>
      </div>
    </div>
  );
...
function GuideView(){
  ...
  async function loadGuide(){
    try {
      // Prima prova a caricare da Firebase (versione modificata) - COMPAT API
      const docRef = db.collection('userData').doc('guide-content');
  ...
  function renderMarkdown(md){
    ...
    // Headers
    html = html.replace(/^### (.+)$/gm,'<h3 style="color:#2563eb;font-size:16px;font-weight:700;margin:20px 0 10px">$1</h3>');
    html = html.replace(/^## (.+)$/gm,'<h2 style="color:#1e40af;font-size:18px;font-weight:800;margin:30px 0 15px;border-bottom:2px solid #dbeafe;padding-bottom:8px">$1</h2>');
    html = html.replace(/^# (.+)$/gm,'<h1 style="color:#1e3a8a;font-size:24px;font-weight:900;margin:40px 0 20px">$1</h1>');
    
    // Bold & Italic
    html = html.replace(/\*\*(.+?)\*\*/g,'<strong style="font-weight:700;color:#1f2937">$1</strong>');
    html = html.replace(/\*(.+?)\*/g,'<em style="font-style:italic">$1</em>');
    
    // Links
    html = html.replace(/\[(.+?)\]\((.+?)\)/g,'<a href="$2" style="color:#2563eb;text-decoration:underline" target="_blank">$1</a>');
    
    // Lists
    html = html.replace(/^- (.+)$/gm,'<li style="margin:4px 0;padding-left:8px">$1</li>');
    html = html.replace(/(<li.+<\/li>\n?)+/g,'<ul style="list-style:disc;padding-left:24px;margin:10px 0">$&</ul>');
    
    // Paragraphs
    html = html.split('\n\n').map(p=>p.trim()?`<p style="margin:12px 0;line-height:1.6">${p}</p>`:'').join('');
    
    return html;
  }
  
  if(loading)return <div style={{padding:40,textAlign:"center",color:"#6b7280"}}>Caricamento guida...</div>;
  
  if(editing){
    return(
      <div style={{padding:20,maxWidth:900,margin:"0 auto"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
          <h2 style={{fontSize:20,fontWeight:800,color:"#1e40af"}}>📝 Modifica Guida</h2>
          <div style={{display:"flex",gap:10}}>
            <button onClick={()=>setEditing(false)} style={{padding:"8px 16px",border:"1px solid #d1d5db",borderRadius:6,background:"white",cursor:"pointer"}}>Annulla</button>
            <button onClick={saveGuide} disabled={saving} style={{padding:"8px 16px",border:"none",borderRadius:6,background:"#2563eb",color:"white",fontWeight:600,cursor:saving?"wait":"pointer",opacity:saving?0.6:1}}>
        ...
        <textarea 
          ...
          style={{width:"100%",height:600,padding:16,border:"1px solid #d1d5db",borderRadius:8,fontSize:14,fontFamily:"Monaco, monospace",lineHeight:1.6}}
          placeholder="Scrivi qui la guida..."
        />
      </div>
    );
  }
  ...
  return(
    <div style={{padding:20,maxWidth:900,margin:"0 auto"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:20}}>
        <h2 style={{fontSize:20,fontWeight:800,color:"#1e40af"}}>📖 Guida Dettagliata</h2>
        <button onClick={()=>setEditing(true)} style={{padding:"8px 16px",border:"1px solid #2563eb",borderRadius:6,background:"white",color:"#2563eb",fontWeight:600,cursor:"pointer"}}>
          ✏️ Modifica
        </button>
      </div>
      <div 
        style={{background:"white",border:"1px solid #e5e7eb",borderRadius:8,padding:24,lineHeight:1.8,color:"#374151"}}
...
function App(){
  ...
  const setSaving = (v) => { isSavingRef.current = v; setIsSaving(v); };
  ...
  const persist = useCallback(async (d) => {
    if (!window.firebaseDB) { alert("⚠️ Firebase non collegato: il salvataggio non parte. (window.firebaseDB mancante)"); return; }
    if (!ready) return;
    setSaving(true);
    try {
      const db = window.firebaseDB;
      ...
      alert("❌ Salvataggio FALLITO\n\nMotivo: " + (e && e.code ? e.code : "") + "\n" + (e && e.message ? e.message : e));
    } finally {
      setTimeout(() => setSaving(false), 500); // Reset after 500ms
    }
  }, [ready]);
  ...
  // Evita di salvare al PRIMO render dopo il caricamento dei dati da Firebase.
  // Senza questo, all'avvio i dati di default sovrascrivono quelli salvati (spese perse).
  const skipSaveDays = useRef(true);
  const skipSaveMemos = useRef(true);
  const skipSaveTransport = useRef(true);

  useEffect(() => {
    if (!ready) return;
    if (skipSaveDays.current) { skipSaveDays.current = false; return; }
    persist(days);
  }, [days, ready, persist]);

  useEffect(() => {
    if (!ready) return;
    if (skipSaveMemos.current) { skipSaveMemos.current = false; return; }
    persistM(memos);
  }, [memos, ready, persistM]);

  useEffect(() => {
    if (!ready) return;
    if (skipSaveTransport.current) { skipSaveTransport.current = false; return; }
    persistT(transportOverrides);
  }, [transportOverrides, ready, persistT]);
